	...
	<body>
		...
		<div id="fh5co-tours" class="fh5co-section-gray">
			<div class="container" id="add-new-house-container">
				...
				<form class="row-bottom-padded-md animate-box" id="add-new-house-form" action="addApartment"  method="POST" enctype="multipart/form-data">
				    ...
				    <input type="radio" name="type" value="ENTIRE" checked required>Entire Apartment<br>
